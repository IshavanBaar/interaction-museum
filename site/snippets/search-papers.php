<!-- OLD VERSION TO TEST JSON REQUESTS FOR PAPER AND SHOW RESPONSES IN LIST --> 
	...
	<div id="search-bar" class="col-lg-6 col-lg-offset-3 search-results">
		<form class="search" method="post">
			...
			<div class="input-group">
				<input type="search" class="form-control" placeholder="Search for papers, authors, keywords, ..." name="publication-query">
