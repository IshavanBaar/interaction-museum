; (function ($, window, document, undefined) {
    ...
    var pluginName = 'mediumInsert',
        addonName = 'Test', // first char is uppercase
        defaults = {
    ...
    Test.prototype.events = function () {
        $(document)
    ...
    Test.prototype.backwardsCompatibility = function () {
        var that = this;
    ...
    Test.prototype.editorSerialize = function () {
    ...
    Test.prototype.togglePlaceholder = function (e) {
        var $place = $(e.target),
    ...
    Test.prototype.fixRightClickOnPlaceholder = function (e) {
    ...
    Test.prototype.processLink = function (e) {
    ...
    Test.prototype.processPasted = function (e) {
    ...
    Test.prototype.oembed = function (url, pasted) {
        var that = this;
    ...
    Test.prototype.parseUrl = function (url, pasted) {
        var html;
    ...
    Test.prototype.embed = function (html, pastedUrl) {
        var $place = this.$el.find('.medium-insert-embeds-active'),
            $div;
     ...
     * @return {void}
     */
    Test.prototype.convertBadEmbed = function (content) {
    ...
    Test.prototype.selectEmbed = function (e) {
        var that = this,
            $embed;
    ...
    Test.prototype.unselectEmbed = function (e) {
    ...
    Test.prototype.removeEmbed = function (e) {
        var $embed, $empty;
    ...
    Test.prototype.addToolbar = function () {
    ...
    Test.prototype.toolbarAction = function (e) {
    ...
    Test.prototype.toolbar2Action = function (e) {
        var $button = $(e.target).is('button') ? $(e.target) : $(e.target).closest('button'),
    ...
    $.fn[pluginName + addonName] = function (options) {
        return this.each(function () {
            if (!$.data(this, 'plugin_' + pluginName + addonName)) {
                $.data(this, 'plugin_' + pluginName + addonName, new Test(this, options));
            }
        });
    };
